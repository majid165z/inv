...
urlpatterns = [
    ...
    # MR Number urls
    path('MR-Number-list',views.mr_number_list,name='mr_number_list'),
    path('MR-Number-add',views.mr_number_add,name='mr_number_add'),
    path('MR-Number-edit/<int:id>',views.mr_number_edit,name='mr_number_edit'),
    ...
    path('material-transfer',views.mir_transfer,name='mir_transfer'),
    # warehouse details
